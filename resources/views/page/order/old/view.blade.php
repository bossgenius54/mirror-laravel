    ...
    <div class="col-sm-8">
        <div class="card card-outline-info">
            ...
            <div class="card-body" style="    padding-bottom: 0px;">
                @include('page.order.offline.__include.view_service_add')
            </div>
            @include('page.order.offline.__include.view_service_list')
        </div>
        <div class="card card-outline-info">
            <div class="card-header">
            ...
            <div class="card-body" style="    padding-bottom: 0px;">
                @include('page.order.offline.__include.view_product_add')
            </div>
            @include('page.order.offline.__include.view_product_list')
        </div>
    </div>
    <div class="col-sm-4">
        @include('page.order.offline.__include.view_main')

        @include('page.order.offline.__include.view_main_edit')
    </div>
</div>
@endsection
