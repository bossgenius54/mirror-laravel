            ...
            <div class="card-body">
                <form class="form-material row" >
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control " placeholder="В филиал" name="in_branch" value="{{ $request->in_branch }}" >
                    </div>
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control " placeholder="От компании" name="from_company" value="{{ $request->from_company }}" >
                    </div>
