    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">
                    {{ $title }}  
                    @can('create', App\Model\View\Doctor::class)
                        <a href="{{ action('Lib\DoctorController@getCreate') }}" type="button" 
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <div class="dropdown-menu">
                                        @can('update', $i)
                                            <a class="dropdown-item" href="{{ action('Lib\DoctorController@getUpdate', $i) }}">
                                                Изменить
                                            </a>
                                        @endcan
                                        @can('delete', $i)
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="{{ action('Lib\DoctorController@getDelete', $i) }}">
                                                Удалить
                                            </a>
                                        @endcan
                                    </div>
