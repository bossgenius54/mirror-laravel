$(function() {
    ...
    $(function() {
        for (var i = window.location,
                 o = $("ul#sidebarnav a").filter(function() { 
                    let str_href = this.href;
                    let window_loc = i.origin+i.pathname;
                    return (str_href == window_loc || window_loc.indexOf(str_href+'/create') == 0 || window_loc.indexOf(str_href+'/update') == 0);
